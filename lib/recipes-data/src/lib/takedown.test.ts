...
describe("takedown.recipesToTakeDown", () => {
  ...
  it("should return a list of recipe references that feature in the DB but not in the incoming update", async () => {
    ...
    expect(result).toEqual([
      {checksum: "vers963", recipeUID: "number2", capiArticleId: "path/to/some/article", sponsorshipCount: 0},
      {checksum: "vers9789", recipeUID: "number5", capiArticleId: "path/to/some/article", sponsorshipCount: 0,}
    ]);
